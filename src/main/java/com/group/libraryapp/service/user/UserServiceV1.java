...
//    @Transactional
    ...
    public List<UserResponse> getUsers() {
        List<User> users = userJdbcRepository.findAll(); //findAll: 알아서 전체 데이터를 읽어서 user객체로 만들어줌
...
//    @Transactional
    public void updateUser(UserUpdateRequest request) {
        User user = userJdbcRepository.findById(request.getId()).orElseThrow();
...
//    @Transactional
    public void deleteUser(String name) {
        ...
        userJdbcRepository.deleteUser(user); // 알아서 UserRepository가 이 user를 제거해줌
    }
...
//    private final UserJdbcRepository userJdbcRepository;
//
//    public UserService(JdbcTemplate jdbcTemplate, UserJdbcRepository userJdbcRepository) {
...
//        List<Integer> users = userJdbcRepository.findUser(request.getId());
//        if (users.isEmpty()){
